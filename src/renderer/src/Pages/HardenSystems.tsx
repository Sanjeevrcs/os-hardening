...
import { Button, Card, Form, Input, Select, SelectProps, Modal, Typography, Progress, Space, Row } from "antd"
...
const HardenSystems = () => {
    ...
    const config = {
        title: (
            <Typography.Title level={4}>Hardening Systems</Typography.Title>
        ),
        content: (
            <>
                <Row justify="center" align="middle">
                    <Progress type="circle" percent={33} format={() => <p style={{ fontSize: '14px' }}>Hardening in Progress</p>} />
                </Row>
                <br />
                <Row justify="center" align="middle">
    ...
    return (
        <ReachableContext.Provider value="">
            <div>
                <PageHeader title="Harden Systems" subTitle="Here you can harden your system by applying the policy you created earlier" />
                <Card
                    style={{
                        padding: '3px'
                    }}
                >
                    <Form name="Policy Apply" layout="vertical" autoComplete="off">
                        ...
                        <Form.Item
                            label="Select a Feature to override"
                            name="overrideFeatures"
                        >
                            <Select mode="multiple" placeholder="Select a Feature to override" options={featureOptions} />
                        </Form.Item>
                        <Form.Item
                            label="Enter IP Address or Hostname"
                            name="ipAddress"
                        >
                            <Select
                                mode="multiple"
                        ...
                        <Button type="primary" htmlType="submit" style={{ width: '100%' }} onClick={handleApplyPolicy}>
                            Apply Policy
                        </Button>
                    </Form>
                </Card>
