  ...
  return (
    <>
      <Form layout="vertical">
        <Row>
          <Col flex="auto">
            <Form.Item label="Do you want to create a user ?" name="createUserPreference">
              <Switch onChange={() => setCreateUserPreference(!createUserPreference)} />
            </Form.Item>

            <Form.Item label="Disable USB Ports" name="usbPortsPreference">
              <Switch />
            </Form.Item>
            <Form.Item label="Disable Root Login" name="rootLoginPreference">
              <Switch />
            </Form.Item>
          </Col>
          <Col flex="auto">
            <Form.Item label="Do you want to set a GRUB Password" name="grubPasswordPreference">
              <Switch onChange={() => setGrubPasswordPreference(!grubPasswordPreference)} />
            </Form.Item>

            <Form.Item label="Enable MAC Randomization" name="macRandomizationPreference">
              <Switch />
            </Form.Item>
            <Form.Item label="Is a Sudoer" name="sudoerPreference">
              <Switch />
            </Form.Item>
          </Col>
          ...
          <Col flex="auto">
            ...
            <Form.Item label="GRUB Password" name="grubPassword">
